...
<html lang="en" class="no-js">
  ...
  <body class="<?php echo is_user_logged_in() ? 'is-logged-in' : '' ; ?>">
    <nav class="open">
        ...
        <p class="social">
            <a href="<?php the_field('twitter_url', 'option') ?>" target="_blank"><img src="<?php echo $twitter['url']; ?>"></a>
            <a href="<?php the_field('facebook_url', 'option') ?>" target="_blank"><img src="<?php echo $facebook['url']; ?>"></a>
        </p>
